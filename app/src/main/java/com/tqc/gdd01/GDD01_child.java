...
private String getBMI (double height, double weight)
        ...
        return getResources().getString(R.string.report_result) + String.valueOf(bmi);
        }
...
private String getAdvice (String Sex, double height, double weight)
        ...
        if(Sex.equals('M')){
                if(bmi < 20){
                        result = getResources().getString(R.string.advice_light);
                }
                else if(bmi < 25){
                        result = getResources().getString(R.string.advice_average);
                }
                else{
                        result = getResources().getString(R.string.advice_heavy);
                }
        }
        else{
                if(bmi < 18){
